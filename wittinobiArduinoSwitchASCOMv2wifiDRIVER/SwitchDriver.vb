...
'
' ASCOM Switch driver for wittinobiArduinoSwitchASCOMv2wifiDRIVER
'
...
'
'
' Your driver's ID is ASCOM.wittinobiArduinoSwitchASCOMv2wifiDRIVER.Switch
'
...
<Guid("e3adfb01-2340-44f0-84ed-2fe5b6ddca57")>
<ClassInterface(ClassInterfaceType.None)>
Public Class Switch

    ' The Guid attribute sets the CLSID for ASCOM.wittinobiArduinoSwitchASCOMv2wifiDRIVER.Switch
    ' The ClassInterface/None attribute prevents an empty interface called
    ' _wittinobiArduinoSwitchASCOMv2wifiDRIVER from being created and used as the [default] interface
    ...
    '
    Friend Shared driverID As String = "ASCOM.wittinobiArduinoSwitchASCOMv2wifiDRIVER.Switch"
    Private Shared driverDescription As String = "wittinobiArduinoSwitchASCOMv2wifiDRIVER Switch"
    ...
    Public Sub New()
        ...
        TL = New TraceLogger("", "wittinobiArduinoSwitchASCOMv2wifiDRIVER")
...
#Region "Common properties and methods"
    ...
    Public ReadOnly Property Name As String Implements ISwitchV2.Name
        Get
            Dim s_name As String = "wittinobiArduinoSwitchASCOMv2wifiDRIVER"
